...
async def read_posts():
    posts = await fetch_all_blog_posts()
...
async def create_post(
    ...
    new_post = await add_blog_post(post_data)
    if new_post is None:
...
async def create_user_endpoint(user: UserCreate = Body(...)):
    user_dict = user.dict()
